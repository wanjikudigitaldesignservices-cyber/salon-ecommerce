export const mockProducts = [
  ...
  { id: 'w1', name: '100% Human Hair Lace Front Wig (Straight & Wavy)', slug: 'human-hair-lace-front-wig', description: 'Premium quality, cuticle-aligned human hair wig.', price: 18000, images: ['/products/prod_wigs.jpg'], category_type: 'wig', in_stock: true, attributes: {} },
  { id: 'w2', name: 'Synthetic Braiding Hair Packs (Various Colors)', slug: 'synthetic-braiding-hair', description: 'High quality synthetic hair for beautiful, long-lasting braids.', price: 600, images: ['/products/prod_wigs.jpg'], category_type: 'wig', in_stock: true, attributes: {} },
  { id: 'w3', name: 'Clip-in Volume Hair Extensions', slug: 'clip-in-volume-extensions', description: 'Instantly add volume and length with these seamless clip-ins.', price: 3500, images: ['/products/prod_wigs.jpg'], category_type: 'wig', in_stock: true, attributes: {} },
  { id: 'w4', name: 'Pre-Plucked Curly Bob Wig', slug: 'pre-plucked-curly-bob', description: 'Bouncy, soft curls on a pre-plucked lace frontal.', price: 12000, images: ['/products/prod_wigs.jpg'], category_type: 'wig', in_stock: true, attributes: {} },
  { id: 'w5', name: 'Afro Kinky Bulk Hair for Twists', slug: 'afro-kinky-bulk-hair', description: 'Perfect texture for natural-looking twists and locs.', price: 1200, images: ['/products/prod_wigs.jpg'], category_type: 'wig', in_stock: true, attributes: {} },
  { id: 'w6', name: 'Drawstring Ponytail Extensions', slug: 'drawstring-ponytail', description: 'Quick and easy drawstring ponytail for a sleek updo.', price: 2500, images: ['/products/prod_wigs.jpg'], category_type: 'wig', in_stock: true, attributes: {} },

  // Hair Foods & Treatments
  { id: 'h1', name: 'Nourishing Herbal Hair Food', slug: 'herbal-hair-food', description: 'Promotes hair growth and soothes the scalp.', price: 450, images: ['/products/prod_haircare.jpg'], category_type: 'beauty_product', in_stock: true, attributes: {} },
  { id: 'h2', name: '100% Pure Raw Shea Butter', slug: 'raw-shea-butter', description: 'Unrefined shea butter for intense moisture.', price: 800, images: ['/products/prod_haircare.jpg'], category_type: 'beauty_product', in_stock: true, attributes: {} },
  { id: 'h3', name: 'Jamaican Black Castor Oil Growth Serum', slug: 'jbco-growth-serum', description: 'Stimulates hair follicles for thicker, longer hair.', price: 1500, images: ['/products/prod_haircare.jpg'], category_type: 'beauty_product', in_stock: true, attributes: {} },
  { id: 'h4', name: 'Deep Conditioning Cholesterol Treatment', slug: 'cholesterol-treatment', description: 'Repairs damaged and over-processed hair.', price: 950, images: ['/products/prod_haircare.jpg'], category_type: 'beauty_product', in_stock: true, attributes: {} },
  { id: 'h5', name: 'Firm Hold Edge Control Gel', slug: 'edge-control-gel', description: 'Keeps edges sleek and smooth all day without flaking.', price: 600, images: ['/products/prod_haircare.jpg'], category_type: 'beauty_product', in_stock: true, attributes: {} },
  { id: 'h6', name: 'Anti-Dandruff Scalp Soothing Spray', slug: 'scalp-soothing-spray', description: 'Relieves itchiness and prevents dandruff flakes.', price: 750, images: ['/products/prod_haircare.jpg'], category_type: 'beauty_product', in_stock: true, attributes: {} },
