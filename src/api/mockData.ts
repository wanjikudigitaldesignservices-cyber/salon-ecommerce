...
export const mockServices = [
  { id: 's1', name: 'Signature Silk Press', duration: '90 min', price: 6500, category: 'Hair' },
  { id: 's2', name: 'Balayage & Color Correction', duration: '180 min', price: 12000, category: 'Hair' },
  { id: 's3', name: 'Luxury Spa Pedicure', duration: '60 min', price: 4000, category: 'Nails' },
  { id: 's4', name: 'Gel Manicure', duration: '45 min', price: 2500, category: 'Nails' },
  { id: 's5', name: 'HydraFacial Treatment', duration: '60 min', price: 8500, category: 'Skin' },
  { id: 's6', name: 'Deep Tissue Massage', duration: '60 min', price: 7000, category: 'Spa' }
];
